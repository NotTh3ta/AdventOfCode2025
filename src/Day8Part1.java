...
public class Day8Part1 {
    public static void main(String[] args) {
        ...
        // For example, make 10 shortest connections
        ...
        circuits.sort(Comparator.comparingInt(HashSet::size));
        long res = 1;
        for (int i = circuits.size()-1; i > circuits.size() - 4; i--) {
            res *= circuits.get(i).size();
        }
